export const Home = () => {
  return (
    <div>
      ...
      <section>
        <h2 className="text-8xl text-center relative text-blue-600 after:content-['pt'] after:text-6xl after:absolute after:right-0 after:bottom-0 before:content-['現在'] before:text-2xl before:absolute before:left-0 before:top-0">
          50
        </h2>
